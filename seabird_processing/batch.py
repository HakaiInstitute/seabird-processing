...
class Batch(object):
    ...
    def get_batch_config_str(self, input_file_pattern: str) -> str:
        ...
        """
        batch_config_str = "@ Generated by the seabird-processing Python package\n"
        next_input_file = input_file_pattern
        for config in self.stages:
            batch_config_str += config.get_config_str(next_input_file)
            next_input_file = config.output_file_path(next_input_file)

        return batch_config_str
